...
# body param
SchemaForRequestBodyApplicationJson = PagesRotate


request_body_pages_rotate = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = PagesRotate
...
class BaseApi(api_client.Api):
    ...
    def _rotate_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_pages_rotate.serialize(body, content_type)
