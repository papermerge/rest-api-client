...
SchemaFor200ResponseBodyApplicationVndApijson = PaginatedDocumentDetailsList
...
class DocumentsList(BaseApi):
    ...
    def documents_list(
        ...
        return self._documents_list_oapg(
