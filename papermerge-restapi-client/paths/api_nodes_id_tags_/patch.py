...
# body param
SchemaForRequestBodyApplicationJson = PatchedNodeTags


request_body_patched_node_tags = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = NodeTags
...
class BaseApi(api_client.Api):
    ...
    def _node_append_tags_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_node_tags.serialize(body, content_type)
...
class NodeAppendTags(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def node_append_tags(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._node_append_tags_oapg(
            body=body,
