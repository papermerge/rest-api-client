...
# body param
SchemaForRequestBodyApplicationVndApijson = Node


request_body_node = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndApijson = Node
...
class BaseApi(api_client.Api):
    ...
    def _nodes_create_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_node.serialize(body, content_type)
