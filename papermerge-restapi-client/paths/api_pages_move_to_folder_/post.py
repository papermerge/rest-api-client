...
# body param
SchemaForRequestBodyApplicationVndApijson = PagesMoveToFolder
SchemaForRequestBodyApplicationJson = PagesMoveToFolder
SchemaForRequestBodyMultipartFormData = PagesMoveToFolder


request_body_pages_move_to_folder = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = PagesMoveToFolder
...
class BaseApi(api_client.Api):
    ...
    def _move_to_folder_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_pages_move_to_folder.serialize(body, content_type)
...
class MoveToFolder(BaseApi):
    ...
    def move_to_folder(
        ...
        return self._move_to_folder_oapg(
            body=body,
