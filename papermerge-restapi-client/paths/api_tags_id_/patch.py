...
# body param
SchemaForRequestBodyApplicationVndApijson = PatchedTag
SchemaForRequestBodyApplicationJson = PatchedTag
SchemaForRequestBodyMultipartFormData = PatchedTag


request_body_patched_tag = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = Tag
...
class BaseApi(api_client.Api):
    ...
    def _tags_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_tag.serialize(body, content_type)
...
class TagsPartialUpdate(BaseApi):
    ...
    def tags_partial_update(
        ...
        return self._tags_partial_update_oapg(
            body=body,
