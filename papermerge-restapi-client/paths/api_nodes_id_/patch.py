...
# body param
SchemaForRequestBodyApplicationVndApijson = PatchedNode


request_body_patched_node = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _nodes_partial_update_oapg(
        self: api_client.Api,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_node.serialize(body, content_type)
...
class NodesPartialUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def nodes_partial_update(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationVndApijson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
        content_type: str = 'application/vnd.api+json',
        ...
        return self._nodes_partial_update_oapg(
            body=body,
