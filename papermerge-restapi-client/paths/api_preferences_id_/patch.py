...
# body param
SchemaForRequestBodyApplicationVndApijson = PatchedCustomUserPreference
SchemaForRequestBodyApplicationJson = PatchedCustomUserPreference
SchemaForRequestBodyMultipartFormData = PatchedCustomUserPreference


request_body_patched_custom_user_preference = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = CustomUserPreference
SchemaFor200ResponseBodyApplicationJson = CustomUserPreference
...
class BaseApi(api_client.Api):
    ...
    def _preferences_partial_update_oapg(
        self: api_client.Api,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_custom_user_preference.serialize(body, content_type)
...
class PreferencesPartialUpdate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def preferences_partial_update(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationVndApijson, SchemaForRequestBodyApplicationJson, SchemaForRequestBodyMultipartFormData, schemas.Unset] = schemas.unset,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        ...
        return self._preferences_partial_update_oapg(
            body=body,
