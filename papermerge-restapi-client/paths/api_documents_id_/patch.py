...
# body param
SchemaForRequestBodyApplicationVndApijson = PatchedDocumentDetails
SchemaForRequestBodyApplicationJson = PatchedDocumentDetails
SchemaForRequestBodyMultipartFormData = PatchedDocumentDetails


request_body_patched_document_details = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = DocumentDetails
...
class DocumentsPartialUpdate(BaseApi):
    ...
    def documents_partial_update(
        ...
        return self._documents_partial_update_oapg(
            body=body,
