...
# body param
SchemaForRequestBodyApplicationVndApijson = PatchedGroup
SchemaForRequestBodyApplicationJson = PatchedGroup
SchemaForRequestBodyMultipartFormData = PatchedGroup


request_body_patched_group = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _groups_partial_update_oapg(
        self: api_client.Api,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_group.serialize(body, content_type)
...
class GroupsPartialUpdate(BaseApi):
    ...
    def groups_partial_update(
        ...
        return self._groups_partial_update_oapg(
            body=body,
