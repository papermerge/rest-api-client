...
# body param
SchemaForRequestBodyApplicationVndApijson = Token
SchemaForRequestBodyApplicationJson = Token
SchemaForRequestBodyMultipartFormData = Token


request_body_token = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndApijson = Token
...
class BaseApi(api_client.Api):
    ...
    def _tokens_create_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_token.serialize(body, content_type)
...
class TokensCreate(BaseApi):
    ...
    def tokens_create(
        ...
        return self._tokens_create_oapg(
            body=body,
