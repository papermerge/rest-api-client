...
# body param
SchemaForRequestBodyApplicationVndApijson = Folder
SchemaForRequestBodyApplicationJson = Folder
SchemaForRequestBodyMultipartFormData = Folder


request_body_folder = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndApijson = Folder
...
class BaseApi(api_client.Api):
    ...
    def _folders_create_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_folder.serialize(body, content_type)
...
class FoldersCreate(BaseApi):
    ...
    def folders_create(
        ...
        return self._folders_create_oapg(
            body=body,
