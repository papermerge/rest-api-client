...
# body param
SchemaForRequestBodyApplicationVndApijson = PagesMoveToDocument
SchemaForRequestBodyApplicationJson = PagesMoveToDocument
SchemaForRequestBodyMultipartFormData = PagesMoveToDocument


request_body_pages_move_to_document = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = PagesMoveToDocument
...
class BaseApi(api_client.Api):
    ...
    def _move_to_document_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_pages_move_to_document.serialize(body, content_type)
...
class MoveToDocument(BaseApi):
    ...
    def move_to_document(
        ...
        return self._move_to_document_oapg(
            body=body,
