...
# body param
SchemaForRequestBodyApplicationVndApijson = Tag
SchemaForRequestBodyApplicationJson = Tag
SchemaForRequestBodyMultipartFormData = Tag


request_body_tag = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndApijson = Tag
...
class BaseApi(api_client.Api):
    ...
    def _tags_create_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_tag.serialize(body, content_type)
