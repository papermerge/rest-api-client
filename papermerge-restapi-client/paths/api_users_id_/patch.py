...
# body param
SchemaForRequestBodyApplicationVndApijson = PatchedUser


request_body_patched_user = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _users_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_user.serialize(body, content_type)
