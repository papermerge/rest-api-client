...
# body param
SchemaForRequestBodyApplicationVndApijson = Ocr
SchemaForRequestBodyApplicationJson = Ocr
SchemaForRequestBodyMultipartFormData = Ocr


request_body_ocr = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = Ocr
SchemaFor200ResponseBodyApplicationJson = Ocr
...
class BaseApi(api_client.Api):
    ...
    def _ocr_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ocr.serialize(body, content_type)
