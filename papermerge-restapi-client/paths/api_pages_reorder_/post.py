...
# body param
SchemaForRequestBodyApplicationJson = PagesReorder


request_body_pages_reorder = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndApijson = PagesReorder
...
class BaseApi(api_client.Api):
    ...
    def _reorder_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_pages_reorder.serialize(body, content_type)
