...
from papermerge-restapi-client import rest
from papermerge-restapi-client.configuration import Configuration
from papermerge-restapi-client.exceptions import ApiTypeError, ApiValueError
from papermerge-restapi-client.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
