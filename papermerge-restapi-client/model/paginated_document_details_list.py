...
class PaginatedDocumentDetailsList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DocumentDetails']:
                        return DocumentDetails
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['DocumentDetails'], typing.List['DocumentDetails']],
                ...
                def __getitem__(self, i: int) -> 'DocumentDetails':
