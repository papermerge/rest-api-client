...
class PaginatedCustomUserPreferenceList(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CustomUserPreference']:
                        return CustomUserPreference
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CustomUserPreference'], typing.List['CustomUserPreference']],
                ...
                def __getitem__(self, i: int) -> 'CustomUserPreference':
