...
"""
    ...
    The version of the OpenAPI document: 2.1.7.dev3
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class attributes(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "title", "lang", "ocr", "ocr_status", "breadcrumb", "versions", "created_at", "updated_at", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "title", "lang", "ocr", "ocr_status", "breadcrumb", "versions", "created_at", "updated_at", ], str]):
