...
# body param
SchemaForRequestBodyApplicationVndApijson = Group
SchemaForRequestBodyApplicationJson = Group
SchemaForRequestBodyMultipartFormData = Group
SchemaFor201ResponseBodyApplicationVndApijson = Group
...
class GroupsCreate(BaseApi):
    ...
    def groups_create(
        ...
        return self._groups_create_oapg(
            body=body,
