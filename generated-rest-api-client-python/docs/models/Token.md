...
------------ | ------------- | ------------- | ------------- | -------------
**type** | [**TokenTypeEnum**](TokenTypeEnum.md) | [**TokenTypeEnum**](TokenTypeEnum.md) |  | 
...
**expiry** | None, str, datetime,  | NoneClass, str,  |  | [optional] value must conform to RFC-3339 date-time
